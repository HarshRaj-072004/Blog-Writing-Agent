...
class EvaluationReport(BaseModel):
    ...
    citation_score: int = Field(..., ge=1, le=10)
...
@traceable(name="_gemini_generate_image_bytes")
...
@traceable(name="generate_and_place_images")
...
EVALUATOR_SYSTEM = """
You are an expert AI content evaluator.

Evaluate the generated blog.

Score the following from 1-10:

1. Coverage of planned topics
2. Citation quality and grounding
3. Structure and readability
4. Hallucination risk

Guidelines:
- Hallucination risk: 10 means extremely risky.
- Coverage: 10 means all planned points covered.
- Citation quality: 10 means claims are well-supported.
- Structure: 10 means excellent organization.
